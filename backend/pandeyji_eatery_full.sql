...
INSERT INTO `order_tracking` VALUES (40,'delivered'),(41,'in progress'),(43,'in progress'),(44,'in progress'),(45,'in progress'),(46,'in progress');
...
INSERT INTO `orders` VALUES (40,1,2,12.00),(41,3,1,8.00),(42,9,1,5.00),(43,3,1,8.00),(44,3,1,8.00),(45,9,1,5.00),(46,3,1,8.00);
...
BEGIN
    ...
    -- Fetch item_id (case-insensitive and trimmed)
    SELECT item_id INTO v_item_id
    FROM food_items
    WHERE LOWER(TRIM(name)) = LOWER(TRIM(p_food_item))
    LIMIT 1;
...
-- Dump completed on 2025-11-02 22:35:50
